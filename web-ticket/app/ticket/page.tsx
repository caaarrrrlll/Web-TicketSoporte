  ...
  const filtrados = useMemo(() => {
    return tickets
      .filter((t) => {
        ...
        const texto =
          t.titulo.toLowerCase() + " " + t.descripcion.toLowerCase();
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <input
        ...
        className="border p-3 rounded-lg w-full mb-4 text-gray-800 placeholder-gray-500"
      />
      <div className="flex flex-wrap gap-3 mb-6">
        <select
          value={estadoQuery || ""}
          onChange={(e) =>
            aplicarFiltro("estado", e.target.value || null)
          }
